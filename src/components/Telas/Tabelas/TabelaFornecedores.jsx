...
import { deletar } from "../../../services/servicoFornecedor";
...
export default function TabelaFornecedores(props) {
    ...
    function deletarFornecedor(fornecedor) {
        if (window.confirm("Deseja realmente excluir o Fornecedor -> " + fornecedor.cnpj)) {
            deletar(fornecedor)
            .then((res) => {
                    dispatch({type: 'deletarFor', payload: fornecedor});
    ...
    return (
        <>
            ...
            <p>Quantidade de Fornecedores cadastrados: {fornecedores.length}</p>
        </>
    );
}